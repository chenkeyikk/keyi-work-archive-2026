...
const filterList=$("#filter-list"), keywordCloud=$("#keyword-cloud"), keywordSummary=$("#keyword-summary"), timelineList=$("#timeline-list"), resultCount=$("#result-count"), searchInput=$("#search-input");
