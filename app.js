...
const metricEvidence={
  "resource-base":{kicker:"DATA FOUNDATION",title:"36所广东国际化学校拓展候选",copy:"以ERP历史记录为主、广州与深圳政府及学校公开名单为补充，剔除现有合作、已停办学校、仅幼儿园、纯高中、日韩学校及非华南归属学校，形成A/B/C逐校拓展池。",evidence:["A类9所：ERP记录较完整或赛事匹配度高。","B类15所：政府及公开名单补漏，需补齐校方接口。","C类12所：ERP非集体或历史线索，学校端切入口较弱。","潜在考量取得校方数据后才进入目标测算，避免重复累计。"]},
