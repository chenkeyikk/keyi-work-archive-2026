...
const metricEvidence={
  ...
  "new-schools":{kicker:"NEW PARTICIPATION",title:"6所新参赛校 + 1个新参赛部",copy:"新赛季已识别并推进的新增参赛对象，是学校拓展指标的直接证据。",evidence:["深圳荟同学校","SWIS深外国际部","深圳梅沙双语学校","广州暨大港澳子弟学校","佛山市中黄星瑜港澳子弟学校","广州科学城爱莎外籍人员子女学校","中山宏科未来初中部"]},
