...
const augustEntries = [
  {date:"8.31",month:"AUG",title:"国际学校新赛季合作推进 / 区域规划细化",summary:"跟进爱莎天河与深圳荟同的新赛季安排，提出双语项目介绍PPT需求，并结合运营例会最新信息细化华南区域工作规划。",categories:["学校拓展","赛事运营","团队管理"],details:["确认向爱莎天河外籍教师寄送实体词库，并同步了解学校的新赛季项目培训及教师支持需求；向项目及品牌侧反馈双语版项目介绍PPT需求。","深圳荟同学校计划于9月中下旬完成英文个人赛初赛；本赛季以英文赛事推进为主，并继续了解外籍老师对ITSO团体赛的参与需求。","结合运营例会最新项目安排，重新梳理汉英双拼全国线上赛事的招生、转化与客户承接思路，细化华南区域阶段性推进重点。"],outcome:"两所重点国际学校新赛季节奏明确 + 区域规划同步更新"},
  {date:"8.27",month:"AUG",title:"韶关美澳签约推进 / 荟同营地课程跟进 / 梅沙双语拜访预约",summary:"完成赛点合作合同用印申请，推进荟同课程方案，并预约梅沙双语学校新赛季入校拜访。",categories:["机构合作","学校拓展","学术支持"],details:["通过宇华OA发起韶关美澳赛点合作合同用印申请，准备后续线下签约。","向深圳荟同学校同步自然拼读、知识图谱、魔力构词、词源语系等营地课程方案。","与万科梅沙双语学校黄老师建立联系，预约下周三入校项目介绍。"],outcome:"机构签约、课程采购与新校拜访三线推进"},
  {date:"8.25-8.26",month:"AUG",title:"广州科学城爱莎与深圳荟同学校拜访",summary:"连续完成两所国际学校的入校沟通，推进城市赛承办、个人赛参赛及营地课程合作。",categories:["学校拓展","学术支持","赛事运营"],details:["广州科学城爱莎外籍人员子女学校对承办广州城市赛有明确意向，并计划重点推荐3-4年级参加英文个人赛。","深圳荟同学校积极推荐汉英双拼、英文个人赛和团体赛，并对系统营地课程采购表达明确意向。","完成岗位说明书及职责权重分析表，进一步梳理岗位边界和绩效重点。"],outcome:"两所国际学校完成深度项目沟通"},
  {date:"8.24",month:"AUG",title:"WWEC建联收尾 / 新财年考核方案意见反馈",summary:"完成大会新增建联整理，参加运营例会，并形成华南赛区绩效与激励方案建议。",categories:["学校拓展","团队管理","数据资产"],details:["与语言培训、研学营地、校区管理系统、留学升学等不同方向的10余位负责人完成初步建联与沟通梳理。","了解SPBCN第12赛季赛事及营地项目的整体时间安排，纳入区域工作规划。","建议按照市场开拓、B端学校对接、C端家长咨询/转化分段归因，更清晰体现不同岗位贡献。"],outcome:"华南赛区绩效考核与激励意见建议稿"},
...
const marketSchoolPool=[
  ["广州斐特思公学","广州","小学-高中","英式融合 / IGCSE / A-Level","A","ERP集体参赛记录"],
  ["华外同文外国语学校","广州","小学-高中","双语融合 / 国际课程","A","ERP集体参赛记录"],
  ["广州博萃德学校","广州","小学-高中","双语 / IGCSE / A-Level","A","ERP集体参赛记录"],
  ["广州番禺华南碧桂园学校","广州","小学-高中","双语融合 / IB","A","ERP集体参赛记录"],
  ["广州贝赛思外籍人员子女学校","广州","K-12","美式 / AP","A","ERP非集体参赛记录"],
  ["深圳前海国王学校","深圳","幼小初高","英式课程","A","ERP集体参赛记录 + 深圳政府名单"],
  ["深圳城市绿洲学校","深圳","小学-初中","Cambridge / 双语","A","ERP非集体参赛记录"],
  ["深圳贝赛思双语学校","深圳","K-12","双语 / 美式课程","A","ERP非集体参赛记录"],
  ["深圳万科双语学校","深圳","小学-初中","双语融合","A","ERP非集体参赛记录"],
  ["东莞东华文泽学校","东莞","小学-高中","双语融合 / 国际课程","A","ERP集体参赛记录"],
  ["广州美国人外籍人员子女学校","广州","K-12","美式 / IB","B","广州公开学校名单补漏"],
  ["广州英国外籍人员子女学校","广州","K-Y13","英式 / IGCSE / A-Level","B","广州公开学校名单补漏"],
  ["广州市英伦外籍人员子女学校","广州","幼小初高","英式 / Cambridge","B","广州公开学校名单补漏"],
  ["广州广外外籍人员子女学校","广州","幼小初","课程体系待核验","B","广州公开学校名单补漏"],
  ["广州恩慧外籍人员子女学校","广州","K-12","美式课程","B","广州公开学校名单补漏"],
  ["广州增城誉德莱外籍人员子女学校","广州","K-12","IB","B","广州公开学校名单补漏"],
  ["佛山市霍利斯外籍人员子女学校","佛山","小学高年级-高中","英式 / IGCSE / A-Level","B","ERP非集体参赛记录"],
  ["深圳科爱赛国际学校（QSI）","深圳","K-12","美式 / AP","B","深圳政府名单补漏"],
  ["深圳爱文学校","深圳","幼小初高","双语融合","B","深圳政府名单补漏"],
  ["深圳前海哈罗外籍人员子女学校","深圳","幼小初高","英式课程","B","深圳政府名单补漏"],
  ["深圳蛇口国际学校（SIS）","深圳","幼小初高","IB / 美式","B","深圳政府名单补漏"],
  ["深圳贝赛思国际学校","深圳","K-12","美式 / AP","B","ERP非集体参赛记录 + 深圳政府名单"],
  ["深圳曼彻斯通城堡学校","深圳","7-12年级","英式 / IGCSE / A-Level","B","深圳政府名单补漏"],
  ["深圳南山国王学校","深圳","幼小初高","英式课程","B","深圳政府名单补漏"],
  ["深圳瑞得福学校","深圳","7-12年级","美式 / AP","B","深圳政府名单补漏"],
  ["上外附属龙岗学校","深圳","小学-高中","双语融合","C","ERP非集体参赛记录"],
  ["深圳南山中英文学校","深圳","小学-初中","双语课程","C","ERP非集体参赛记录"],
  ["深圳南山中英文学校太子湾实验部","深圳","小学-初中","双语课程","C","ERP非集体参赛记录"],
  ["深圳东方英文书院","深圳","小学-高中","双语 / 国际课程","C","ERP非集体参赛记录"],
  ["深圳罗湖华美外国语学校","深圳","小学-高中","双语 / 国际课程","C","ERP非集体参赛记录"],
  ["深圳宝安为明双语学校","深圳","小学-高中","双语课程","C","ERP非集体参赛记录"],
  ["深圳珊蒂泉外国语学校","深圳","小学-高中","双语 / 国际课程","C","ERP非集体参赛记录"],
  ["东莞海德双语学校","东莞","小学-高中","双语课程","C","ERP非集体参赛记录"],
  ["惠州碧桂园十里银滩学校","惠州","小学-高中","双语 / 国际课程","C","ERP非集体参赛记录"],
  ["佛山顺德碧桂园实验学校","佛山","小学-高中","双语融合","C","ERP非集体参赛记录"],
  ["中山纪念中学三鑫双语学校","中山","小学-高中","双语 / 国际课程","C","ERP非集体参赛记录"],
  ["广州法国国际学校（EFIC）","广州","幼小初高","法国国家课程","C","ERP非集体参赛记录"]
];
function renderMarketPool(){
  const root=$("#market-detail-groups"); if(!root)return;
  const tierCopy={A:"内部记录较完整或赛事适配度高",B:"政府及公开名单补漏，待建立校方接口",C:"ERP历史线索，待寻找学校端切入口"};
  root.innerHTML=["A","B","C"].map(tier=>{
    const rows=marketSchoolPool.filter(row=>row[4]===tier);
    return `<section class="market-detail-group"><div class="market-city-head"><span>PRIORITY ${tier}</span><h4>${tier}类客户池</h4><p>${tierCopy[tier]} · ${rows.length}所</p></div><div class="market-school-list">${rows.map(([name,city,stage,curriculum,priority,source])=>{
...
const metricEvidence={
  "resource-base":{kicker:"DATA FOUNDATION",title:"37所广东国际化学校拓展候选",copy:"以ERP历史记录为主、广州与深圳政府及学校公开名单为补充，剔除现有合作、仅幼儿园、纯高中、日韩学校及非华南归属学校，形成A/B/C逐校拓展池。",evidence:["A类10所：ERP记录较完整或赛事匹配度高。","B类15所：政府及公开名单补漏，需补齐校方接口。","C类12所：ERP非集体或历史线索，学校端切入口较弱。","潜在考量取得校方数据后才进入目标测算，避免重复累计。"]},
  tracking:{kicker:"SCHOOL BASELINE",title:"36所第11赛季实际参赛学校",copy:"第11赛季华南英文个人赛实际覆盖深圳25所、广州11所学校，实际考量合计26,945人，是新赛季学校续报与拓展判断的基础。",evidence:["36所集体参赛校共有9,710人初赛晋级、1,247人复赛付费，晋级后付费转化率为12.84%。","当前新学期校方已确认13所，S12考量合计10,457人；预计考量代注册12所，考量合计12,086人。","四张执行表分别跟踪校方确认、预计代注册、未注册老校和新增学校/学部。","27,000人为初赛保底，约33,000人为完成3,000人复赛付费目标的经营规模。"]},
  "new-schools":{kicker:"NEW PARTICIPATION",title:"3所待推进新校 + 1个新参赛部",copy:"新增参赛对象按学校主体去重。深圳梅沙双语学校、深圳荟同学校、广州暨大港澳子弟学校（英东校区）青藤AP&AL国际课程已作为本赛季新拓展校计入校方确认表，不在待推进清单中重复累计。",evidence:["广州执鸿学校（初中部已建联，新赛季将组织参赛）","中山市弘科未来学校中学部","佛山市中黄星瑜港澳子弟学校","广州科学城爱莎外籍人员子女学校（已确认参赛，有意向承办广州城市赛）"]},
...
function renderKeywords(){const stats=keywordRules.map(([word])=>({word,count:entries.filter(e=>e.keywords.includes(word)).length})).filter(item=>item.count).sort((a,b)=>b.count-a.count);keywordSummary.textContent=`${entries.length}个工作节点 · ${stats.length}类高频标签`;keywordCloud.innerHTML=stats.map(({word,count})=>`<button type="button" data-keyword="${word}" class="${activeKeyword===word?"active":""}" title="${word}：${count}个日报节点"><span>${word}</span><em>${count}</em></button>`).join("")}
...
renderFilters();renderKeywords();renderTimeline();renderMarketPool();
